...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomStaticMesh = { "CustomStaticMesh", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AUIWSCustomBody, CustomStaticMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomStaticMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomStaticMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomMeshComp = { "CustomMeshComp", nullptr, (EPropertyFlags)0x0010000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AUIWSCustomBody, CustomMeshComp), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomMeshComp_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomMeshComp_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomWaterVolume = { "CustomWaterVolume", nullptr, (EPropertyFlags)0x00200c000008000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(AUIWSCustomBody, CustomWaterVolume), Z_Construct_UClass_UBoxComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomWaterVolume_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AUIWSCustomBody_Statics::NewProp_CustomWaterVolume_MetaData)) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UIWS_Source_UIWS_Public_UIWSCustomBody_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UIWS_Source_UIWS_Public_UIWSCustomBody_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AUIWSCustomBody, AUIWSCustomBody::StaticClass, TEXT("AUIWSCustomBody"), &Z_Registration_Info_UClass_AUIWSCustomBody, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AUIWSCustomBody), 1127947255U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UIWS_Source_UIWS_Public_UIWSCustomBody_h_3812541848(TEXT("/Script/UIWS"),
		Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UIWS_Source_UIWS_Public_UIWSCustomBody_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Build_U5M_Marketplace_Mac_Sync_LocalBuilds_PluginTemp_HostProject_Plugins_UIWS_Source_UIWS_Public_UIWSCustomBody_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
